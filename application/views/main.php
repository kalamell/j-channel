		...
		<div class="container">
			<div class="header">
				...
				<div class="sub-header h-three" onclick="top.location.href = 'http://j-channel.jp/th/oimf/';" style="cursor: pointer;">
					...
					เมืองโอกินาว่า ประเทศญี่ปุ่น</p>
					<img src="<?php echo base_url();?>assets/images/toon.png" alt="">
				</div>
			</div>
			<div class="content">
				<div class="container">
			...
			<div class="condition">
				<div class="container">
					<p>เงื่อนไขการรับรางวัล</p>

					<p>1. ผู้โชคดีสามารถรับรางวัลได้เพียง 1 รางวัลเท่านั้น</p>
					<p>2. รางวัลที่ได้รับ ไม่สามารถแลก เปลี่ยน หรือทอนเป็นเงินสด
					และไม่สามารถโอนสิทธ์ให้บุคคลและนิติบุคคลอื่นได้</p>
					<p>3. ผู้ที่ได้รับรางวัลต้องมีอายุไม่น้อยกว่า 20 ปีบริบูรณ์
					และต้องมีหนังสือเดินทางที่มีอายุของหนังสือเดินทางไม่น้อยกว่า 6 เดือน ณ
					วันเดินทาง</p>
					<p>4. หากผู้ที่ได้รับรางวัลไม่สามารถเดินทางออกจากประเทศไทย และ/หรือ
					ไม่สามารถเดินทางเข้าสู่ด่านตรวจคนเข้าเมืองหรือด่านศุลกากรของประเทศญี่
					ปุ่นได้ไม่ว่าจะกรณีใดก็ตาม
					จะถือว่าเป็นการสิ้นแพ็คเกจสุดการไปทัวร์ประเทศญี่ปุ่น
					และบริษัทฯขอสงวนสิทธิ์ในการไม่รับผิดชอบหรือชดใช้ต่อกรณีดังกล่าว</p>
					<p>5. บริษัทฯ
					ขอสงวนสิทธิ์เปลี่ยนแปลงรายละเอียดของรางวัลโดยไม่แจ้งให้ทราบล่วงหน้า</p>
					<p>6. บริษัทฯ ขอสงวนสิทธิ์ในการถ่ายภาพนิ่ง ภาพเคลื่อนไหว
					และบันทึกเสียงของผู้โชคดี โดยถือเป็นสิทธิ์ขาดของบริษัทฯ
					ในการเผยแพร่และประชาสัมพันธ์ได้โดยไม่ต้องขออนุญาตและให้ค่าตอบแ
					ทนแก่ผู้โชคดี</p>
					<p>7. ผู้โชคดีจะต้องชำระภาษี ณ ที่จ่าย 5% ของมูลค่าของรางวัลที่ได้รับ</p>
